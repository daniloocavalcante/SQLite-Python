...
tk.Label(frm_form, text="Endereco:").grid(row=5, column=0, sticky="w", padx=(0,8))
entrada_endereco= tk.Entry(frm_form, width=40)
entrada_endereco.grid(row=5, column=1, sticky="w")
entrada_endereco.bind("<KeyRelease>", lambda e: atualizar_botoes())

tk.Label(frm_form, text="CEP:").grid(row=10, column=0, sticky="w", padx=(0,8))
entrada_cep= tk.Entry(frm_form, width=40)
entrada_cep.grid(row=10, column=1, sticky="w")
...
tabela.column("cep", width=60, anchor="w")
